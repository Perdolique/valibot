...
const language: Language = {
  ...
  specific: {
    ...
    domain:           (issue) => `Λάθος domain: Ήρθε ${issue.received}`,
    ...
    entries:          (issue) => `Λάθος entries: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    graphemes:        (issue) => `Λάθος graphemes: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    gtValue:          (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    guard:            (issue) => `Λάθος input: Ήρθε ${issue.received}`,
    ...
    jwsCompact:       (issue) => `Λάθος JWS compact: Ήρθε ${issue.received}`,
    length:           (issue) => `Λάθος μάκρος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ltValue:          (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    maxEntries:       (issue) => `Λάθος entries: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    maxGraphemes:     (issue) => `Λάθος graphemes: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    maxLength:        (issue) => `Λάθος μάκρος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    maxSize:          (issue) => `Λάθος μέγεθος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    maxValue:         (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    minEntries:       (issue) => `Λάθος entries: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    minGraphemes:     (issue) => `Λάθος graphemes: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    minLength:        (issue) => `Λάθος μέγεθος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    minSize:          (issue) => `Λάθος μέγεθος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    minValue:         (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    minWords:         (issue) => `Λάθος λέξεις: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    multipleOf:       (issue) => `Λάθος multiple: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    nanoid:           (issue) => `Λάθος Nano ID: Ήρθε ${issue.received}`,
    nonEmpty:         (issue) => `Λάθος μάκρος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notBytes:         (issue) => `Λάθος bytes: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notEntries:       (issue) => `Λάθος entries: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notGraphemes:     (issue) => `Λάθος graphemes: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notLength:        (issue) => `Λάθος μάκρος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notSize:          (issue) => `Λάθος μέγεθος: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notValue:         (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    notValues:        (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    parseBoolean:     (issue) => `Λάθος boolean: Ήρθε ${issue.received}`,
    parseJson:        (issue) => `Λάθος JSON: Ήρθε ${issue.received}`,
    partialCheck:     (issue) => `Λάθος input: Ήρθε ${issue.received}`,
    rawCheck:         (issue) => `Λάθος input: Ήρθε ${issue.received}`,
    rawTransform:     (issue) => `Λάθος input: Ήρθε ${issue.received}`,
    regex:            (issue) => `Λάθος format: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    slug:             (issue) => `Λάθος slug: Ήρθε ${issue.received}`,
    someItem:         (issue) => `Λάθος αντικείμενο: Ήρθε ${issue.received}`,
    startsWith:       (issue) => `Λάθος start: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    ...
    toString:         (issue) => `Λάθος string: Ήρθε ${issue.received}`,
    ...
    value:            (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
    values:           (issue) => `Λάθος αξία: Αναμενόταν ${issue.expected} αλλά ήρθε ${issue.received}`,
